...
HD_PWD='C:/Users/J/Desktop/FPGA FinalProject/FinalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZZ_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZZ_Top.tcl -notrace
