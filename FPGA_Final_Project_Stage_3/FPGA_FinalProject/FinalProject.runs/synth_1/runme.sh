...
HD_PWD='C:/Users/J/Desktop/FPGA FinalProject/FinalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZZ_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZZ_Top.tcl
