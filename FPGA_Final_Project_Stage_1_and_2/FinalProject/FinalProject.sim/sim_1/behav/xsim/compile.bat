...
REM
REM Generated by Vivado on Mon May 02 11:44:38 -0400 2022
...
echo "xvhdl --incr --relax -prj robotFSM_tb_vhdl.prj"
call xvhdl  --incr --relax -prj robotFSM_tb_vhdl.prj -log xvhdl.log
